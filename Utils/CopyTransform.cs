...
namespace AnderSystems
{
    ...
    public class CopyTransform : MonoBehaviour
    {
        ...
        public void CopyPosAndRot()
        {
            ...
            if (transform && CopyPosition != null)
            {
                if (CopyPos)
                {
                    ToCopy(transform, CopyPosition, CopyType.Position);
                }
        ...
        public void Reset()
        {
            ...
            if (transform && CopyPosition != null)
            {
                if (CopyPos)
                {
                    transform.position = CopyPosition.Target.position;
                }

                if (CopyRot)
                {
                    transform.rotation = CopyRotation.Target.rotation;
                }
            }
        }
